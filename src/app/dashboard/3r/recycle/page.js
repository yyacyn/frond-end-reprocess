// app/dashboard/3r/recycle/RecycleContent.jsx
    ...
    const fetchRecommendations = async () => {
        try {
            const response = await fetch(
                `http://202.10.47.143:8090/api/generate-recommendations/${wasteId}`
            );
            if (!response.ok) {
            ...
            if (textContent) {
                ...
                if (action === "recycle" && parsedData[1]) {
                    const recycleData = parsedData[1];
                    setRecommendations([recycleData]);
                    setSelectedRecommendation(recycleData);

                    // Create action immediately
                    createAction(recycleData);
                } else {
    ...
    const createAction = async (recommendation) => {
        try {
            const actionData = {
                ...
                insight: recommendation.insight || "AI-generated waste recycle recommendation",
                ...
                tasks: JSON.stringify([
                    {
                        ...
                        description: `Research best practices for ${recommendation.category || "waste recycle"
                    ...
                    },
                    {
                        ...
                        description:
                            "Create a tracking system to monitor the impact of your waste recycle efforts.",
                        estimated_days: 7,
                    },
                    {
                        title: "Implement Changes",
                        description:
                            "Begin implementing the waste recycle strategy in your daily routine.",
                        estimated_days: 14,
                    },
                    {
                        title: "Share Results",
    ...
    const validateTaskCompletion = async () => {
        ...
        try {
            ...
            if (isValid) {
                ...
                setValidationError(
                    "Validation failed. Please provide more details about your completed tasks."
                );
            }
        } catch (error) {
            ...
            <div className="flex-1 flex items-center justify-center bg-gradient-to-br from-base-200 to-base-300">
                <div className="text-center">
                    ...
                    <p className="text-xl font-semibold text-base-content">
                        Generating waste recycle recommendations...
                    </p>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                                ...
                                <div className="stat bg-gradient-to-r from-warning/10 to-warning/5 rounded-lg border border-warning/20">
                                    ...
                                    <div className="stat-value text-warning text-lg">
                                        {wasteData.on_sale ? "On Sale" : "Available"}
                                    </div>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <div className="space-y-4">
                                                <div>
                                                    <p className="text-blue-800 bg-white/50 p-3 rounded-lg">
                                                        Basic waste awareness action completed: You've taken the first step by
                            ...
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-base-content/70">
                                        Complete these tasks for more points
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 gap-6">
                                {recommendations.map((recommendation, index) => (
                                    ...
                                    >
                                        <div className="card-body">
                                            <div className="flex items-start justify-between mb-4">
                                                <h3 className="text-xl font-bold text-green-800">Recycle Strategy #{index + 1}</h3>
                                            ...
                                            <div className="space-y-4">
                                                <div>
                                                    ...
                                                    <p className="text-green-800 bg-white/50 p-3 rounded-lg">
                                                ...
                                                <div className="grid grid-cols-2 gap-4">
                                                    ...
                                                    <div className="bg-white/70 p-3 rounded-lg text-center">
                                                        <div className="text-2xl font-bold text-green-600">
                                                            {recommendation.quantity_kg}kg
                                                        </div>
                                                        <div className="text-sm text-green-700">recycle Target</div>
                                                    </div>
                                                </div>
                        ...
                        <div className="card-body">
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-base-content/70">
                                        Provide details about how you've completed the task
                                    </p>
                                </div>
                            </div>
                            ...
                            {!validationSuccess ? (
                                    ...
                                    <div className="space-y-6">
                                            ...
                                            <div className="flex">
                                                ...
                                                <div className="ml-3">
                                                    <p className="text-sm text-yellow-700">
                                                        To earn your points, please describe in detail how you've implemented the
                                                        waste recycle strategy. Include specific actions taken, challenges
                                        ...
                                        <div>
                                            ...
                                            <textarea
                                                ...
                                                placeholder="Describe in detail how you've implemented this waste recycle strategy. Include specific steps taken, methods used, challenges faced, and any measurable results (e.g., 'I recycled my plastic consumption by 30% by...', 'I implemented a composting system that processes 2kg of waste weekly...', etc.)"
                                ...
                                <div className="text-center py-8">
                                    ...
                                    <p className="text-lg text-base-content/70 mb-6">
                                        Congratulations! Your waste recycle efforts have been validated and you've earned
                                        impact points.
                                    </p>
                                        ...
                                        <div className="flex gap-3">
                                            ...
                                            <div>
                                                <h3 className="font-bold text-blue-800">
                                                    Complete more tasks for additional points!
                                                </h3>
                                                <p className="text-sm text-blue-600">
                                                    You've successfully recycled waste. Want to earn more impact points? Try
                                                    completing additional waste recycle tasks.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
