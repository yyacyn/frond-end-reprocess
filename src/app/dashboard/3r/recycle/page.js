                ...
                tasks: JSON.stringify([
                    {
                        ...
                        description: `Research best practices for ${recommendation.category || "waste recycle"} related to this material.`,
                        estimated_days: 2
                    },
                    {
                    ...
                    },
                    {
                        ...
                        description: "Create a tracking system to monitor the impact of your waste recycle efforts.",
                        estimated_days: 7
                    },
                    {
                        title: "Implement Changes",
                        description: "Begin implementing the waste recycle strategy in your daily routine.",
                        estimated_days: 14
                    },
                    {
                        title: "Share Results",
            ...
            <div className="flex h-screen">
                ...
                <div className="flex-1 flex items-center justify-center bg-gradient-to-br from-base-200 to-base-300">
                    <div className="text-center">
                        ...
                        <p className="text-xl font-semibold text-base-content">Generating waste recycle recommendations...</p>
                                ...
                                {!validationSuccess ? (
                                                ...
                                                <div className="flex">
                                                    ...
                                                    <div className="ml-3">
                                                        <p className="text-sm text-yellow-700">
                                                            To earn your points, please describe in detail how you've implemented the waste recycle strategy.
                                    ...
                                    <div className="text-center py-8">
                                        ...
                                        <p className="text-lg text-base-content/70 mb-6">
                                            Congratulations! Your waste recycle efforts have been validated and you've earned impact points.
                                        </p>
                                            ...
                                            <div className="flex gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-sm text-blue-600">
                                                        You've successfully recycled waste. Want to earn more impact points?
                                                        Try completing additional waste recycle tasks.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
